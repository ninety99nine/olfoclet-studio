...
class SubscriberController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if(request()->routeIs('api.show.subscriber')) {
            ...
            $this->subscriber = $this->project->subscribers()->where('msisdn', request()->subscriber_msisdn)->with(['latestSubscription.latestBillingTransaction', 'latestSubscription.pricingPlan'])->first();
