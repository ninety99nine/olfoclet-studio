...
trait PricingPlanTrait
{
    public function craftInsufficientFundsMessage()
    {
        return $this->handleEmbeddedDynamicContentConversion($this->insufficient_funds_message, [
            'pricingPlanName' => $this->name,
            'pricingPlanPrice' => $this->price->amount_with_currency,
        ]);
    }
    ...
    public function craftSuccessfulAutoBillingPaymentSmsMessage(Subscription $subscription)
    {
    ...
    public function craftNextAutoBillingReminderSmsMessage(Subscription $subscription)
    {
    ...
    public function processPHPCode($phpCode = 'return null', $variables = [])
    {
        ...
        foreach ($variables as $key => $value) {
             ...
             *  Example:
             *
             *  $variables = ['pricingPlan' => {...}, 'subscription' => {...}, ...e.tc];
             *
