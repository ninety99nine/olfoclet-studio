import{a as u}from"./index-60992bd7.js";import{G as p,M as a,o as s,e as d,r as c,c as g,L as m,f}from"./app-eac08db9.js";import{f as b,s as h}from"./index-f632f76f.js";import{s as x}from"./index-d3ee0064.js";import{s as v,a as y,b as $}from"./index-4e747bef.js";var w=`
    .p-textarea {
        font-family: inherit;
...
`,M={root:function(n){var t=n.props,i=n.instance;return["p-inlinemessage p-component p-inlinemessage-"+t.severity,{"p-inlinemessage-icon-only":!i.$slots.default}]},icon:function(n){var t=n.props;return["p-inlinemessage-icon",t.icon]},text:"p-inlinemessage-text"},j=p.extend({name:"inlinemessage",style:H,classes:M}),A={name:"BaseInlineMessage",extends:h,props:{severity:{type:String,default:"error"},icon:{type:String,default:void 0}},style:j,provide:function(){return{$pcInlineMessage:this,$parentInstance:this}}},E={name:"InlineMessage",extends:A,inheritAttrs:!1,timeout:null,data:function(){return{visible:!0}},mounted:function(){var n=this;this.sticky||setTimeout(function(){n.visible=!1},this.life)},computed:{iconComponent:function(){return{info:v,success:x,warn:y,error:$}[this.severity]}}};function V(e,n,t,i,l,r){return s(),d("div",a({role:"alert","aria-live":"assertive","aria-atomic":"true",class:e.cx("root")},e.ptmi("root")),[c(e.$slots,"icon",{},function(){return[(s(),g(m(e.icon?"span":r.iconComponent),a({class:e.cx("icon")},e.ptm("icon")),null,16,["class"]))]}),e.$slots.default?(s(),d("div",a({key:0,class:e.cx("text")},e.ptm("text")),[c(e.$slots,"default")],16)):f("",!0)],16)}E.render=V;export{E as a,R as s};
