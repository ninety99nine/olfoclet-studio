<template>
    ...
    <div>
        ...
        <div class="mb-6 gap-4">
            ...
            <div class="bg-gray-50 border-b pl-6 py-3 rounded-t text-gray-500 text-sm mb-6">
                ...
                <span v-if="smsCampaign.schedule_type == 'Send Recurring'">
                    ...
                    <span class="text-gray-300 mx-4">|</span>
                    <span><span class="text-gray-400">Start: </span>{{ moment(smsCampaign.start_datetime).format('DD MMM YYYY HH:mm') }}</span>
                    <span class="text-gray-300 mx-4">|</span>
                    <span><span class="text-gray-400">End: </span>{{ moment(smsCampaign.end_datetime).format('DD MMM YYYY HH:mm') }}</span>
                </span>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="smsCampaignBatchJob in smsCampaignBatchJobsPayload.data" :key="smsCampaignBatchJob.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ smsCampaignBatchJob.created_at == null ? '...' : moment(smsCampaignBatchJob.created_at).format('DD MMM YYYY HH:mm') }}
                                </td>
                            </tr>
            ...
            <!-- Pagination Links -->
            <Pagination class="mt-6" :pagination-payload="smsCampaignBatchJobsPayload" :update-data="['smsCampaignBatchJobsPayload']" />
