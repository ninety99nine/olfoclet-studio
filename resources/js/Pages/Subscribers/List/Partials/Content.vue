                    ...
                    <div class="shadow border-b border-gray-200">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 whitespace-nowrap text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-teal-50 border-r border-dotted border-r-teal-300">

                                </th>
                                <th scope="col" colspan="4" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-teal-50">
                                    <div class="font-bold text-teal-500">LAST SUBSCRIPTION</div>
                                </th>
                                <th scope="col" colspan="5" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-fuchsia-50 border-r border-dotted border-r-fuchsia-300">

                                </th>
                                <th scope="col" colspan="5" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-fuchsia-50">
                                    <div class="font-bold text-fuchsia-500">LAST USER BILLING</div>
                                </th>
                                <th scope="col" colspan="5" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-violet-50 border-r border-dotted border-r-violet-300">

                                </th>
                                <th scope="col" colspan="5" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-violet-50">
                                    <div class="font-bold text-violet-500">LAST AUTO BILLING</div>
                                </th>
                                <th scope="col" colspan="5" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-emerald-50 border-r border-dotted border-r-emerald-300">

                                </th>
                                <th scope="col" colspan="2" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-emerald-50">
                                    <div class="font-bold text-emerald-500">LAST MESSAGE</div>
                                </th>
                                <th scope="col" colspan="2" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 whitespace-nowrap text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-fuchsia-50 border-r border-dotted border-r-fuchsia-300">
                                ...
                                <th scope="col" class="px-6 py-3 whitespace-nowrap text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-violet-50 border-r border-dotted border-r-violet-300">
                                    <span>% Unsuccessful</span>
                                </th>
                                ...
                                <th scope="col" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-emerald-50">
                                ...
                                <th scope="col" class="px-6 py-3 whitespace-nowrap text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-emerald-50 border-r border-dotted border-r-emerald-300">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="subscriber in subscribersPayload.data" :key="subscriber.id">
                                    ...
                                    <!-- Total Messages -->
                                    <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500 text-center bg-emerald-50">
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500 text-center bg-emerald-50 border-r border-dotted border-r-emerald-300">
                                    ...
                                    <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500 bg-emerald-50">
        ...
        methods: {
            ...
            getPercentageOfSuccessfulUserBilling(subscriber) {
                if( subscriber.user_billing_transactions_count > 0 && subscriber.successful_user_billing_transactions_count > 0){
                    return Math.round((subscriber.successful_user_billing_transactions_count / subscriber.user_billing_transactions_count) * 50)
                }
            ...
            getPercentageOfUnsuccessfulUserBilling(subscriber) {
                if( subscriber.user_billing_transactions_count > 0 && subscriber.unsuccessful_user_billing_transactions_count > 0){
                    return Math.round((subscriber.unsuccessful_user_billing_transactions_count / subscriber.user_billing_transactions_count) * 50)
                }
            ...
            getPercentageOfSuccessfulAutoBilling(subscriber) {
                if( subscriber.auto_billing_transactions_count > 0 && subscriber.successful_auto_billing_transactions_count > 0){
                    return Math.round((subscriber.successful_auto_billing_transactions_count / subscriber.auto_billing_transactions_count) * 50)
                }
            ...
            getPercentageOfUnsuccessfulAutoBilling(subscriber) {
                if( subscriber.auto_billing_transactions_count > 0 && subscriber.unsuccessful_auto_billing_transactions_count > 0){
                    return Math.round((subscriber.unsuccessful_auto_billing_transactions_count / subscriber.auto_billing_transactions_count) * 50)
                }
            ...
            getPercentageOfCoverage(MessagesCount){
                if( this.totalMessages > 0 ){
                    return Math.round((MessagesCount / this.totalMessages) * 50)
                }
