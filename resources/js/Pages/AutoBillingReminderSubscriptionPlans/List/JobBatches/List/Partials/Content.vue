<template>
    ...
    <div>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="autoBillingReminderJobBatch in subscriptionPlanAutoBillingReminderJobBatchesPayload.data" :key="autoBillingReminderJobBatch.id">
                                <!-- Name -->
                            ...
                            <tr v-if="subscriptionPlanAutoBillingReminderJobBatchesPayload.data.length == 0">
                                <!-- Content -->
            ...
            <!-- Pagination Links -->
            <pagination class="mt-6" :paginationPayload="subscriptionPlanAutoBillingReminderJobBatchesPayload" :updateData="['subscriptionPlanAutoBillingReminderJobBatchesPayload']" />
...
<script>
    ...
    export default defineComponent({
        ...
        props: {
            ...
            subscriptionPlanAutoBillingReminderJobBatchesPayload: Object
        },
        data() {
            return {
