<template>
    ...
    <div>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="autoBillingReminderJobBatch in pricingPlanAutoBillingReminderJobBatchesPayload.data" :key="autoBillingReminderJobBatch.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ autoBillingReminderJobBatch.created_at == null ? '...' : moment(autoBillingReminderJobBatch.created_at).format('DD MMM YYYY HH:mm') }}
                                </td>
                            </tr>
            ...
            <!-- Pagination Links -->
            <Pagination class="mt-6" :pagination-payload="pricingPlanAutoBillingReminderJobBatchesPayload" :update-data="['pricingPlanAutoBillingReminderJobBatchesPayload']" />
