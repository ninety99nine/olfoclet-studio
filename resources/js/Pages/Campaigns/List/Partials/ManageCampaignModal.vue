    ...
    export default defineComponent({
        ...
        computed: {
            ...
            frequencyOptions(){
                return [
                    {
                        name: this.form.recurring_duration == '1' ? 'Second': 'Seconds',
                        value: 'Seconds'
                    },
                    {
        ...
        methods: {
            ...
            reset() {
                this.form = this.$inertia.form({
                    ...
                    start_time: this.hasCampaign ? this.campaign.start_time : '06:00',
                    end_time: this.hasCampaign ? this.campaign.end_time : '18:00',
