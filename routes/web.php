    ...
    Route::prefix('/projects')->group(function () {
        ...
        Route::prefix('{project}')->group(function () {
            ...
            Route::prefix('subscription-plans')->group(function () {
                ...
                Route::prefix('{pricing_plan}')->middleware(['project.permission:Manage subscription plans'])->group(function () {
            ...
            Route::prefix('auto-billing/subscription-plans')->group(function () {
                ...
                Route::prefix('{pricing_plan}')->middleware(['project.permission:Manage auto billing subscription plans'])->group(function () {
